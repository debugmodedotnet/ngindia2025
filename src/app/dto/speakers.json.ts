...
export const speakers: ISpeakers[] = [
  ...
  },
  {
    ...
    bio: 'Rainer Hahnekamp is a Google Developer Expert (GDE) and a core team member of NgRx. He runs ng-news, a weekly Angular newsletter. Beyond NgRx, he is deeply involved in open source, working on projects like Testronaut and Sheriff.',
  ...
  },
  {
  ...
  },
   {
    ...
    position: 'Team Lead @ XTB',
    bio: 'Jaroslaw Zolnowski is a Team Lead at XTB with strong experience in building and leading modern web applications. He works closely with frontend teams to design scalable, maintainable solutions and is passionate about code quality, performance, and best engineering practices. Jaroslaw actively shares his knowledge with the developer community and contributes to open-source projects. He enjoys mentoring teams, solving complex technical challenges, and staying up to date with the evolving JavaScript and frontend ecosystem.',
    image: 'assets/images/speakers/jaroslow.jpg',
    flag: 'assets/images/speakers/flags/poland.png',
    twitter: 'https://x.com/JarekZolnowski',
    linkedin: 'https://www.linkedin.com/in/jaroslaw-zolnowski/',
    github: 'https://github.com/jzolnowski',
    youtube: '',
    previousTalks: [
    ],
  },
...
// himanshu 
  ...
  //   image: 'assets/images/speakers/himanshu-saraswat.jpeg',
  //   flag: 'assets/images/speakers/flags/india.png',
  //   twitter: '',
  //   linkedin: 'https://www.linkedin.com/in/himanshusaraswat/',
  //   github: '',
  //   youtube: '',
  //   previousTalks: [
  //     {
  ...
  //   bio: 'Tomasz Ducin is experienced in both frontend and backend. He is a JavaScript expert, passionate about programming, involved in the industry since 2007. Ex-theater actor, probably addicted to coffee and certainly addicted to listening to music.',
  ...
  //   image: 'assets/images/speakers/enea-jahollari.webp',
  //   flag: 'assets/images/speakers/flags/albania.png',
...
// Vojtech 
  ...
  //   name: 'Vojtech Mašek',
  //   position: 'CTO @flowup',
  //   bio: 'Vojtech Mašek is a software engineer with expertise in Angular and TypeScript. He has co-founded FlowUp, a software development agency. He has built a team of great developers along with his fantastic colleagues. His job is to ensure that projects are delivered with cutting-edge tech and ready to go live and large.',
  ...
  //   flag: 'assets/images/speakers/flags/serbia.png',
