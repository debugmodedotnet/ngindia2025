...
export const speakers: ISpeakers[] = [
  ...
  // },
  {
    ...
    bio: 'Michael Hladky is a Google Developer Expert, MVP, NX Champion and an active part of the community. As co-founder of the Angular-Austria association, organizer of Angular-Vienna and NestJS-Vienna Meetup he grows the Austrian community. He is a developer, trainer and consultant with the focus on Angular as well as ionic and surrounding technologies, and gives workshops on Angular, RxJs and Typescript.',
